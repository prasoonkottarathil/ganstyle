...
batchSize =256 # We set the size of the batch.
...
# Loading the dataset
dataset = dset.CIFAR10(root = './data', download =False, transform = transform) # We download the training set in the ./data folder and we apply the previous transformations on each image.
...
optimizerDis = optim.Adam(netDis.parameters(), lr = 0.0002, betas = (0.5, 0.999))
optimizerGen = optim.Adam(netGen.parameters(), lr = 0.0002, betas = (0.5, 0.999))
